...
/** openGauss Catalog factory. */
@AutoService(Factory.class)
public final class OpenGaussCatalogFactory implements CatalogFactory {

    private static final String DEFAULT_DRIVER = "org.opengauss.Driver";

    @Override
    public String factoryIdentifier() {
        return OpenGaussCatalog.DIALECT;
    }
    ...
    public Catalog createCatalog(String catalogName, ReadonlyConfig options) {
        ...
        JdbcCatalogConfig config = new JdbcCatalogConfig(
                ...
                properties,
                false);
        return new OpenGaussCatalog(catalogName, config, schema);
    }
}
