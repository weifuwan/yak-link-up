...
/** YashanDB Catalog factory. */
@AutoService(Factory.class)
public final class YashanDbCatalogFactory implements CatalogFactory {

    private static final String DEFAULT_DRIVER = "com.yashandb.jdbc.Driver";

    @Override
    public String factoryIdentifier() {
        return YashanDbCatalog.DIALECT;
    }
    ...
    public Catalog createCatalog(String catalogName, ReadonlyConfig options) {
        ...
        JdbcCatalogConfig config = new JdbcCatalogConfig(
                ...
                properties,
                false);
        return new YashanDbCatalog(catalogName, config, schema);
    }
}
