...
/** KingbaseES Catalog factory. */
@AutoService(Factory.class)
public final class KingbaseCatalogFactory implements CatalogFactory {

    private static final String DEFAULT_DRIVER = "com.kingbase8.Driver";

    @Override
    public String factoryIdentifier() {
        return KingbaseCatalog.DIALECT;
    }
    ...
    public Catalog createCatalog(String catalogName, ReadonlyConfig options) {
        ...
        JdbcCatalogConfig config = new JdbcCatalogConfig(
                ...
                properties,
                false);
        return new KingbaseCatalog(catalogName, config, schema);
    }
}
